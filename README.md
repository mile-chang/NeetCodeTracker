...
|  | 49 | [Group Anagrams](./01-Arrays-and-Hashing/49-Group-Anagrams) | Medium | 🔴 🔴  | 2025-12-27 (5d ago) | 🔥 Retry | <details><summary>🔍 Hint</summary>Blocker: Could not figure out how to group anagrams efficiently.<br>Key Insight: When we see group or duplicate question, maybe we cau use the hash map.<br>Method: ord()、defaultdict、tuple().<br></details> |
| **02-Two-Pointers** | 15 | [3Sum](./02-Two-Pointers/15-3Sum) | Medium | 🔴  | 2025-12-29 (3d ago) | 🔥 Retry | <details><summary>🔍 Hint</summary>enumerate method, two pointers</details> |
|  | 167 | [Two Sum II - Input Array Is Sorted](./02-Two-Pointers/167-Two-Sum-II---Input-Array-Is-Sorted) | Medium | 🔴 🟡  | 2025-12-30 (2d ago) |  | <details><summary>🔍 Hint</summary>finish but need use print to debug, need to see constraints more carefully.</details> |
